...
import { FaUser, FaLock, FaGoogle, FaFacebook, FaCheckCircle, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="min-h-screen flex items-center justify-center bg-white relative overflow-hidden">
            ...
            <div className="w-full max-w-md mx-auto bg-transparent shadow-md rounded-xl overflow-hidden relative z-10">
                <div className="p-8">
                    ...
                    {/* Heading */}
                    <div
                        className="flex items-center justify-center space-x-4 select-none mb-6"
                ...
                duration-300 ease-in-out">
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600">
                        ...
                        <Link href="/login" passHref>
                            <span className="font-medium text-indigo-600 transition duration-300 ease-in-out 
